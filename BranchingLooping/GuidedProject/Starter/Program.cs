...
string[,] ourAnimals = new string[maxPets, maxAnimalInfo];
...
do
{
  ...
  switch (menuSelection)
  {
    case "1":
      ...
      {
        if (ourAnimals[petIndex, 0] != "ID #: ")
        {
          Console.WriteLine();
          for (int infoIndex = 0; infoIndex < maxAnimalInfo; infoIndex++)
          {
            Console.WriteLine(ourAnimals[petIndex, infoIndex]);
          }
        }
      }
      Console.WriteLine("Press the Enter key to continue.");
      ...
      while (anotherPet == "y" && petCount < maxPets)
      {
        ...
        do
        {
          ...
          if (readResult != null)
          {
            ...
            string[] validAnimalSpecies = ["dog", "cat"];
            if (validAnimalSpecies.Contains(animalSpecies))
            {
              validEntry = true;
